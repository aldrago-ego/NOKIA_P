  ...
  return (
    <div className="p-6 bg-[#F4F6FA] min-h-full">
      <div className="flex items-center gap-2 mb-1">
        <h1 className="text-xl font-bold text-[#0F172A]">{t('loansPage.title')}</h1>
        {selectedProject && (
      ...
      <p className="text-sm text-slate-500 mb-6">{t('loansPage.subtitle')}</p>

      {selectedProjectId == null ? (
        <p className="text-sm text-slate-400">{t('common.loadingProject')}</p>
      ) : (
